...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void UnityARCameraSettings_ReadProfile_m02290EC65B3EF631E42195D779694D34AE785BB3 (UnityARCameraSettings_tEE96490B50567703BEFDD8FF113C55A76CC58CA9* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Debug_LogWarning_mEF15C6B17CE4E1FA7E379CDB82CE40FCD89A3F28(_stringLiteral6798986EE6D13B043A77AFD8D1CABA0C685A8E8C, NULL);
		// return;
		goto IL_0052;
	}
...
IL_001f:
	{
		...
		UnityARCameraSettingsProfile_t97681668F15F49FB481014F0668E5E9CFAE523D3* L_3;
		L_3 = UnityARCameraSettings_get_SettingsProfile_m52A51ED6AC70FE5FF0025D88224A46CAAB0822B4(__this, NULL);
		NullCheck(L_3);
		int32_t L_4;
		L_4 = UnityARCameraSettingsProfile_get_PoseSource_m4E461938D0D9A31FAA244B90E5EE60D08818DA50_inline(L_3, NULL);
		__this->___poseSource_15 = L_4;
		// trackingType = SettingsProfile.TrackingType;
		UnityARCameraSettingsProfile_t97681668F15F49FB481014F0668E5E9CFAE523D3* L_5;
		L_5 = UnityARCameraSettings_get_SettingsProfile_m52A51ED6AC70FE5FF0025D88224A46CAAB0822B4(__this, NULL);
		NullCheck(L_5);
		int32_t L_6;
		L_6 = UnityARCameraSettingsProfile_get_TrackingType_mF344A20835D8987D73DFE8528076B2087495840F_inline(L_5, NULL);
		__this->___trackingType_16 = L_6;
		// updateType = SettingsProfile.UpdateType;
		UnityARCameraSettingsProfile_t97681668F15F49FB481014F0668E5E9CFAE523D3* L_7;
		L_7 = UnityARCameraSettings_get_SettingsProfile_m52A51ED6AC70FE5FF0025D88224A46CAAB0822B4(__this, NULL);
		NullCheck(L_7);
		int32_t L_8;
		L_8 = UnityARCameraSettingsProfile_get_UpdateType_m11C9BC522B7936D704FB6B3D869F39AA9984D0C7_inline(L_7, NULL);
		__this->___updateType_17 = L_8;
	}
...
{
	{
		...
		// private ArTrackingType trackingType = ArTrackingType.RotationAndPosition;
		__this->___trackingType_6 = 0;
		// private ArUpdateType updateType = ArUpdateType.UpdateAndBeforeRender;
		__this->___updateType_7 = 0;
