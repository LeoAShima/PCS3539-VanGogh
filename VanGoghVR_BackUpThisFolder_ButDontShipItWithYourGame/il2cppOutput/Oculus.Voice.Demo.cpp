...
IL_0032:
	{
		...
		int32_t L_10 = V_2;
		bool L_11;
		L_11 = Input_GetKeyUp_m4A66DE48A7B1B25374D4FDD31208EFE43C972842(L_10, NULL);
		V_4 = L_11;
		bool L_12 = V_4;
		if (!L_12)
		{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void InteractionHandler_OnRequestResponse_mD626BC43DF858049ED759E87366889AB3E8804E8 (InteractionHandler_t15828C462891DE52D1A7017CBD539754CB8B732E* __this, WitResponseNode_tACC149B056FE33C54D55A5EAB653A77902617DBB* ___response0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		String_t* L_10;
		L_10 = WitResponseNode_op_Implicit_mBEC61604C409E23E9D4BEBA57CE513B294B68AB6(L_9, NULL);
		String_t* L_11;
		L_11 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral34073A77D1FC0099E5D4E1AA07A1A3995BF30CF5, L_10, NULL);
		NullCheck(L_7);
...
IL_0042:
	{
		...
		L_5 = TimeSpan_FromSeconds_mE585CC8180040ED064DC8B6546E6C94A129BFFC5(L_4, NULL);
		V_0 = L_5;
		...
		String_t* L_25;
		L_25 = String_Format_m74FC0A1259DFA02F3DF6538FC7F3ACF3E1AF0C55(_stringLiteral377C585B1B1DFB2354530C907FF3AF34F921983D, L_20, NULL);
		V_2 = L_25;
		goto IL_00af;
	}
